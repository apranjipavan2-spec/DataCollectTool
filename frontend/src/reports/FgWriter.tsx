...
export default function FgWriter() {
  ...
  useEffect(() => { if (style === 'donor') setIncludeCover(true) }, [style])
                  ...
                  <div className={card}>
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex gap-2">
                        ...
                        <label className="flex items-center gap-1.5 text-xs text-catalan-textMuted">
