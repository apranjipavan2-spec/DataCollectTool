...
def list_forms(
    ...
    forms = q.options(load_only(Form.id, Form.title, Form.version, Form.status, Form.created_at, Form.updated_at, Form.allow_enumerator_edit, Form.is_public, Form.public_token)).order_by(Form.title).all()
