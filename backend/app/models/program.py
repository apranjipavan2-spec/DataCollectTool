...
class Program(Base, SoftDeleteMixin):
    ...
    # MEAL: which form's submissions count as beneficiary feedback for this program (nullable)
    feedback_form_id = Column(UUID(as_uuid=True), ForeignKey("forms.id", ondelete="SET NULL"), nullable=True)
