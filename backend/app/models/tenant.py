from sqlalchemy import Column, String, DateTime, Boolean, Numeric, func, text
...
class Tenant(Base):
    ...
    notification_config = Column(JSONB, default=dict, server_default=text("'{}'::jsonb"))
    ai_config = Column(JSONB, default=dict, server_default=text("'{}'::jsonb"))
