...
SEED_PHONES = {
    ...
    # Real production master_admin (+918317390926) deliberately NOT in this list —
    # this script must never touch or reset a real person's credential. That
    # account's password lives only in the database.
