...
def detect_and_stamp():
    ...
    if table_exists(cur, "tenants"):
        ...
        if not table_exists(cur, "schedules"):
            ...
            stamp = "0045"
        elif not table_exists(cur, "submission_drafts"):
            stamp = "0046"
        elif not col_exists(cur, "submissions", "deleted_at"):
            ...
            stamp = "0049"
        elif not col_exists(cur, "audit_log", "row_hash"):
            stamp = "0056"
        elif not table_exists(cur, "data_rights_requests"):
            stamp = "0057"
        elif not col_exists(cur, "users", "failed_login_count"):
            stamp = "0059"
        elif not col_exists(cur, "forms", "retention_days"):
            stamp = "0060"
        elif not col_exists(cur, "forms", "deleted_at"):
            stamp = "0061"
