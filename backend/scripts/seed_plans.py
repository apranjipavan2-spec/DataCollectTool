...
UNIFIED_PLANS = [
    dict(
        ...
        active_forms_limit=5,    ai_reports_per_month=2,  api_calls_per_month=20,
        ai_calls_per_day=5,
        max_org_admins=1,        max_supervisors=2,       max_enumerators=2,
        asr_minutes_limit=10,    translation_chars=0,
        ai_cleaning=True, ai_writer=True, ai_smart_builder=True,
        ai_interpret=True, ai_analyzer=True, map_view=True,
        panel_study=True, spss_export=True, api_write=True,
        webhooks=False, two_fa=False, sso=False, audit_log=False,
    ...
    dict(
        ...
        price_inr=0, price_usd_cents=0,
        submissions_limit=300,   storage_limit_mb=50,
        active_forms_limit=2,    ai_reports_per_month=2,  api_calls_per_month=20,
        ai_calls_per_day=1,
        max_org_admins=1,        max_supervisors=2,       max_enumerators=2,
        asr_minutes_limit=10,    translation_chars=0,
        ai_cleaning=False, ai_writer=False, ai_smart_builder=False,
    ...
    dict(
        ...
        active_forms_limit=8,    ai_reports_per_month=5,  api_calls_per_month=20,
        ai_calls_per_day=5,
        max_org_admins=2,        max_supervisors=5,       max_enumerators=20,
        asr_minutes_limit=20,    translation_chars=5000,
        ai_cleaning=True, ai_writer=True, ai_smart_builder=False,
        ai_interpret=False, ai_analyzer=True, map_view=True,
        panel_study=False, spss_export=False, api_write=True,
        webhooks=False, two_fa=False, sso=False, audit_log=False,
    ...
    dict(
        ...
        submissions_limit=5000,  storage_limit_mb=2048,
        active_forms_limit=20,   ai_reports_per_month=30, api_calls_per_month=200,
        ai_calls_per_day=15,
        max_org_admins=5,        max_supervisors=20,      max_enumerators=50,
        asr_minutes_limit=50,    translation_chars=60000,
        ai_cleaning=True, ai_writer=True, ai_smart_builder=True,
        ai_interpret=True, ai_analyzer=True, map_view=True,
        panel_study=True, spss_export=True, api_write=True,
        webhooks=True, two_fa=True, sso=True, audit_log=True,
        advanced_rbac=False, white_label=False, on_premise=False, priority_support=True,
    ),
    dict(
        ...
        submissions_limit=20000, storage_limit_mb=5096,
        active_forms_limit=100,  ai_reports_per_month=100, api_calls_per_month=1000,
        ai_calls_per_day=100,
        max_org_admins=20,       max_supervisors=100,     max_enumerators=500,
        asr_minutes_limit=500,   translation_chars=None,
        ai_cleaning=True, ai_writer=True, ai_smart_builder=True,
        ai_interpret=True, ai_analyzer=True, map_view=True,
        panel_study=True, spss_export=True, api_write=True,
        webhooks=True, two_fa=True, sso=False, audit_log=True,
